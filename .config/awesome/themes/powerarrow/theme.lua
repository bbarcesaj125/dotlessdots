...
--]]
		...
		local brightwidget = awful.widget.watch('light -G', 0.1,
			...
			arrow(theme.bg_normal, "#3B7C82"),
			wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), "#3B7C82"),
			--arrow(theme.bg_normal, "#343434"),
